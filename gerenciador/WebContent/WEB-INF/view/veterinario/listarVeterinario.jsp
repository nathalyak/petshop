...
<html>
	<head>
		...
		<title>Pet Care | Lista de Veterinários</title>
			...
			<div class="row">
				...
				<ul id="lista" class="col-12">
					...
					<c:forEach items="${listaNome}" var="veterinarios">
						<li class="row">
							<p class="col-4 col-md-9">${veterinarios.nomeVeterinario}</p>
							<a class="col-2 col-md-1" href="paginas?acao=MostraVeterinario&pacote=veterinario.&tipo=Exibe&id=${veterinarios.idVeterinario}" ><img class="icon-lista" src="./static/image/informacoes.svg"></a>
							<a class="col-2 col-md-1" href="paginas?acao=MostraVeterinario&pacote=veterinario.&tipo=Altera&id=${veterinarios.idVeterinario}" ><img class="icon-lista" src="./static/image/lapis.svg"></a>
							<a class="col-2 col-md-1" href="paginas?acao=RemoveVeterinario&pacote=veterinario.&id=${veterinarios.idVeterinario}" ><img class="icon-lista" src="./static/image/lixo.svg"></a>
						</li> 
					</c:forEach>
				</ul>
			</div>
