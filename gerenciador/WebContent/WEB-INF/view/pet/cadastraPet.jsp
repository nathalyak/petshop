				...
				<div class="row">
					<div class="form-group col-12">
						<label for="nomePet">Nome do pet</label>
  						<input required id="nomePet" name="nomePet" type="text" class="form-control">
					</div>
					...
					<div class="form-group col-12 col-md-6">
						<label for="especie">Espécie</label>
  						<input required id="especie" name="especie" type="text" class="form-control">
					</div>
					<div class="form-group col-12 col-md-6">
						<label for="raca">Raça</label>
  						<input required id="raca" name="raca" type="text" class="form-control">
					</div>
					<div class="form-group col-12 col-md-6">
						<label for="porte">Porte</label>
  						<input required id="porte" name="porte" type="text" class="form-control">
					</div>
